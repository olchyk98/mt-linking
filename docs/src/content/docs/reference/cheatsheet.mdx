...
Check the [strategy table](using-oink/linking-strategies/) and confirm your folder names trigger the right strategy.
...
<Aside type="note">
  <p>Still stuck? Grab the <a href="reference/tips/">Day-to-Day Tips</a> page for more context before filing an issue.</p>
</Aside>
